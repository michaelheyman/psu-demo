...
class list
{
    public:
        ...
        int addToEnd(node*& head, int index, int sum, int total);
        ...
        int addAfter2(node*& head, node * prev, int toAdd, int added);
        ...
        int addBefore2(node*& head, node* prev, int toAdd, int added);
        ...
        int appendIfDivisible(node*& head, node* curr, int toAdd, int count);
